/*version usando arreglo dinamico en vez de arreglo estatico

Observacion: para este problema realmente no se necesita, ya que la naturaleza
del mismo proporciona los medios para basarnos en estructuras estaticas que
terminan optimizando mucho más los tiempos de ejecucion
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
int main(int argc, char *argv[]){
	...
	for(int i = 1; i <= longitud; i++) {
		if(temp == partition) {
			...
			temp_data.datos = malloc(sizeof(int) * temp_data.size);
